            ...
            <div class="blog_main col-md-9">
                <div class="blog_list">
                    <div class="col-md-12 blog_left">
                        <a href="#"><img src="<?php echo __IMG__;?>paramoconejos.jpg" alt="" class="img-responsive"/></a>
                        <h4>Páramo de Los Conejos.</h4>

                        <p class="para">El Municipio venezolano es la unidad política primaria de la organización nacional, con personalidad jurídica, autonomía y con un gobierno democrático. Su fortalecimiento es un mandato de la Constitución, la cual impone, en su artículo 4°, el desarrollo del Estado Federal y Descentralizado.
                            ...
                            El Municipio representa el autogobierno y la soberanía popular de los vecinos. En su jurisdicción, el Alcalde, como principal figura ejecutiva local, es quien da la cara a la población que espera respuestas efectivas a sus demandas.</p>
                        ...
                        <p class="para" id="parra1" style="display: none;">
                            ...
                            Por lo antes expuesto, los hombres y mujeres, candidatos a Alcaldes y Concejales de la Unidad Democrática,  se comprometen ante el país a rescatar y defender un Municipio democrático,  que enfrente los problemas de la gente. Para ello, será necesaria una gestión guiada por los siguientes principios:<br>
                            ...
                            . Ejercer un gobierno y una legislación basados en la participación, cercanía e inclusión de los vecinos, consejos comunales y demás organizaciones sociales del Municipio, para la solución de los problemas, en especial de los más pobres, liderando y promoviendo el ejercicio de  la seguridad, la solidaridad y la corresponsabilidad ciudadana.<br>
                            . Promover el desarrollo económico local como vía para el emprendimiento, la creación de empleos de calidad y la economía social, pilares fundamentales para generar ingresos para el Municipio e impulsar  el progreso de la gente.<br>
                            . Conducir una gestión basada en la defensa y el eficiente manejo de los recursos fiscales, la generación de recursos propios, la transparencia y la rendición de cuentas como guía para la promoción de la confianza entre el gobierno municipal y los habitantes.<br>
                            . Desarrollar la institucionalidad municipal a través  de las mejores relaciones de cooperación con los  niveles de gobierno estadales y nacional.<br></p>
...
<div class="main_bg"><!-- start main -->
    <div class="container">
        <div class="main_grid1">
            <h3 class="style pull-left">Primer Eje: El bienestar de la población.</h3>
            <div class="clearfix"></div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="blog"><!-- start blog -->
            <div class="blog_main col-md-9">
                <div class="blog_list">
                    <div class="col-md-12 blog_left">
                        <a href="#"><img src="<?php echo __IMG__;?>peje.jpg" alt="" class="img-responsive"/></a>
                        <h4>Garantízar servicios públicos con calidad para todos.</h4>

                        <p class="para">La mayoría de los servicios públicos necesarios para la vida pueden prestarse en el Municipio. Para ello es imprescindible respetar su autonomía política y financiera.
                            La atención primaria en salud y la educación preescolar y básica; la recolección de la basura; la distribución de agua y el servicio de cloacas; la movilidad y el transporte; la distribución de alimentos; la vivienda; los espacios públicos y áreas verdes, la cultura y el deporte, la formación de recursos humanos, la seguridad vecinal y la lucha contra la violencia, entre otros, son servicios que deben ser manejados por el Municipio, en cooperación con los gobiernos estadales y nacional, y con la presencia de la población organizada.</p>
                        <div class="col-md-2 span1_of_2" id="btn2">
                            <a class="btn" href="#!" onclick="muestraParra(2);">ver mas</a>
                        </div>
                        <p class="para" id="parra2" style="display: none">
                ...
                <div class="blog_list">
                    <div class="col-md-12 blog_left">
                        <h4>Garantízar derechos de familias  e individuos en situación de vulnerabilidad.</h4>

                        <p class="para">La Alcaldía y el Concejo Municipal son las instancias del Estado más cercanas a la población. Sólo desde allí es posible conocer y abordar los problemas individuales y familiares de sus habitantes. El Municipio es la unidad territorial privilegiada para ejecutar las políticas sociales y la atención a las familias e individuos más vulnerables.
...
<div class="main_bg"><!-- start main -->
    <div class="container">
        <div class="main_grid1">
            <h3 class="style pull-left">Segundo Eje: Empoderamiento y Emprendimiento.</h3>
            <div class="clearfix"></div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="blog"><!-- start blog -->
            <div class="blog_main col-md-9">
                <div class="blog_list">
                    <div class="col-md-12 blog_left">
                        <a href="#"><img src="<?php echo __IMG__;?>seje.jpg" alt="" class="img-responsive"/></a>
                        <h4>El municipio como espacio de la participación de los vecinos, consejos comunales, mesas técnicas, organizaciones sociales y comunidades en la gestión.</h4>

                        <p class="para">La Mesa de la Unidad Democrática y sus candidatos a Alcaldes y  Concejales asumirán la deuda que tiene el país con las aspiraciones de participación del pueblo. Por ello, nuestra gestión se basará en los espacios participativos consagrados en la Constitución, para construir un Estado para la gente.
                            Garantizamos un gobierno local  que respete la autonomía de consejos comunales, mesas técnicas y de todas las organizaciones sociales que se desempeñan en el Municipio. Sin exclusión política. La participación de todos estará presente en cada acto de nuestra gestión.</p>
                        <div class="col-md-2 span1_of_2" id="btn3">
                            <a class="btn" href="#!" onclick="muestraParra(3);">ver mas</a>
                        </div>
                        <p class="para" id="parra3" style="display: none">Para ello, además, nuestros Alcaldes y Concejales promoverán las mejores condiciones para que la población participe con igualdad  y con acceso a la información sobre la gestión.
                        ...
                        <div class="col-md-2 span1_of_2" id="ocu3" style="display: none;">
                            <a class="btn" href="#!" onclick="ocultaParra(3);">ocultar</a>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="blog_list">
                    <div class="col-md-12 blog_left">
                        <h4>El desarrollo económico local para el beneficio de la gente.</h4>

                        <p class="para">El gobierno municipal debe ser el principal agente del desarrollo económico local  sustentable, a través de la creación de espacios institucionales  para la innovación, la creación de conocimientos y la articulación del gobierno municipal con universidades, gremios y  emprendedores locales. El Municipio debe ofrecer condiciones para que los inversionistas y emprendedores, grandes y pequeños, de la economía privada y de la economía social, puedan desarrollar actividades que generen  empleos de calidad  y seguridad de ingresos.</p>
                        <div class="col-md-2 span1_of_2" id="btn4">
                            <a class="btn" href="#!" onclick="muestraParra(4);">ver mas</a>
                        </div>
                        <p class="para" id="parra4" style="display: none">
                            ...
                            Las economías de los pequeños y medianos centros poblados serán objeto de promoción especial en nuestra gestión. Allí existen múltiples oportunidades de creación de nuevas actividades y generación de empleos, a partir del conocimiento y las tradiciones productivas. Son actividades vinculadas con las potencialidades de cada Municipio, que facilitan la consolidación de desarrollos agrícolas, agroindustriales y  de turismo local, con gran porvenir.</p>
                        <div class="col-md-2 span1_of_2" id="ocu4" style="display: none;">
                            <a class="btn" href="#!" onclick="ocultaParra(4);">ocultar</a>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
...
<div class="main_bg"><!-- start main -->
    <div class="container">
        <div class="main_grid1">
            <h3 class="style pull-left">Tercer Eje: Ciudadanía y Confianza Social.</h3>
            <div class="clearfix"></div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="blog"><!-- start blog -->
            <div class="blog_main col-md-9">
                <div class="blog_list">
                    <div class="col-md-12 blog_left">
                        <a href="#"><img src="<?php echo __IMG__;?>teje.jpg" alt="" class="img-responsive"/></a>
                        <h4>Un municipio para la paz, la justicia, la seguridad y la convivencia.</h4>

                        <p class="para">Seremos activos promotores de la Justicia de Paz, la prevención y protección vecinal y los servicios de policía municipal. En ese camino, utilizaremos la justicia como espacio donde el ciudadano pueda encontrar en su comunidad una alternativa para solucionar sus conflictos.
                            En ese esfuerzo, impulsaremos la participación del ciudadano en la prevención de la seguridad ciudadana y en su relación con la Policía Municipal como una estrategia para fortalecer la lucha contra la violencia.<p>
                        <div class="col-md-2 span1_of_2" id="btn5">
                            <a class="btn" href="#!" onclick="muestraParra(5);">ver mas</a>
                        </div>
                        <p class="para" id="parra5" style="display: none;">
                            ...
                            Los Alcaldes y Concejales de la Unidad Democrática se proponen ser promotores de la Paz y la seguridad ciudadana en todos los Municipios del país, construyendo espacios propicios para el desarrollo de la vida individual, familiar y en comunidad.</p>
                        <div class="col-md-2 span1_of_2" id="ocu5" style="display: none;">
                            <a class="btn" href="#!" onclick="ocultaParra(5);">ocultar</a>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="blog_list">
                    <div class="col-md-12 blog_left">
                        <h4>La defensa y promoción de las finanzas del municipio y su gestión transparente.</h4>

                        <p class="para">El esquema fiscal que ha prevalecido en Venezuela ha sido la dependencia de los Gobiernos Locales de las transferencias que les concede el Poder Central. Creemos en otra manera de administrar los recursos.
                            Por una parte, nuestros Alcaldes y Concejales serán defensores de los recursos que por Situado Constitucional, Asignaciones Especiales y Fondo de Compensación Territorial les pertenecen al Municipio y su población. </p>
                        <div class="col-md-2 span1_of_2" id="btn6">
                            <a class="btn" href="#!" onclick="muestraParra(6);">ver mas</a>
                        </div>
                        <p class="para" id="parra6" style="display: none">
                            Por ello, se demandará un Consejo Federal de Gobierno plural que garantice  la distribución equitativa de los recursos públicos hacia los Municipios.
                            ...
                            El ciudadano necesita volver a descubrir el valor de la institución municipal. La transparencia como principio permite crear la confianza de los ciudadanos y fortalece al Municipio como unidad política primaria. Los gobiernos de la Unidad Democrática en los Municipios venezolanos tendrán en la transparencia un norte de su gestión.</p>
                        <div class="col-md-2 span1_of_2" id="ocu6" style="display: none;">
                            <a class="btn" href="#!" onclick="ocultaParra(6);">ocultar</a>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
...
<div class="main_bg"><!-- start main -->
    <div class="container">
        <div class="main_grid1">
            <h3 class="style pull-left">Declaración Final.</h3>
            <div class="clearfix"></div>
        </div>
    </div>
</div>
