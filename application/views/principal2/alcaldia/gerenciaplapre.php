<div class="main_bg"><!-- start main -->
    <div class="container">
        <div class="main_grid1">
            <h3 class="style pull-left">GERENCIA DE PLANIFICACIÓN Y PRESUPUESTO</h3>
            ...
            <div class="blog_main col-md-9">
                <div class="blog_list">
                    ...
                    <div class="col-md-10 blog_left">
                        <a href="#"><img src="<?php echo __MAQ2__;?>images/presupuesto.jpg" alt="" class="img-responsive"/></a>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="blog_list">
                    ...
                    <div class="col-md-10 blog_left">
                        <a href="#"><img src="<?php echo __MAQ2__;?>images/presupuesto2.jpg" alt="" class="img-responsive"/></a>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="clearfix"></div>
